...
import { useCreateViolationCategory } from '../_hooks/use-create-violation-category';
import { createViolationCategorySchema } from '../_schemas/create-violation-category-schema';

const MODAL_ID = 'create-new-violation-category';

export const AddViolationCategoryModal = () => {
  return (
    <MenuItem
      ...
      onClick={() =>
        modals.open({
          modalId: MODAL_ID,
          title: 'Create new violation category',
...
const ModalContent = () => {
  const { mutate, isPending } = useCreateViolationCategory({
